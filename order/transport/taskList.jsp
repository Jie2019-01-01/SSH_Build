			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>下单人:</td>
						<td><s:textfield size="10" name="oqm.creater.name"/></td>
						<td>&nbsp;</td>
						<td><a id="query"> 
					...
					<tr>
						...
						<td>发货方式:</td>
						<td>
							<s:select list="@cn.itcast.erp.invoice.supplier.vo.SupplierModel@needsMap" 
								 name="oqm.sm.needs" headerKey="-1" headerValue="---请-选-择--" cssStyle="width:115px"/> 
						</td>
						<td>审核人:</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="orderList">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>${createrTimeView }</td>
							<td>${creater.name }</td>
							<td>${checkerTimeView }</td>
							<td>${checker.name }</td>
							<td>${sm.name }</td>
							<td>${sm.needsView }</td>
							<td>
								...
								<s:else>
									<span style="line-height:12px; text-align:center;">${completer.name }</span>
								</s:else>
							</td>
						</tr>
					</s:iterator>
