			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td> 
							<s:select list="@cn.itcast.erp.invoice.order.vo.OrderModel@buyTypeMap" headerKey="-1" 
								headerValue="---请-选-择---" cssClass="kuan" cssStyle="width:125px;height:22px"/>
						</td>
						<td>下单人:</td>
