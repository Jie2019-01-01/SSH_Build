...
public class SupplierModel {
	...
	public static final Integer SUPPLIER_NEEDS_IS_YES = 0;
	public static final Integer SUPPLIER_NEEDS_IS_NO = 1;
	
	public static final String SUPPLIER_NEEDS_IS_YES_VIEW = "送货";
	public static final String SUPPLIER_NEEDS_IS_NO_VIEW = "自取";
